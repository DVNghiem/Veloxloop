...
class TestUDPTransport:
    ...
    def test_udp_echo_server_client(self):
        ...
        async def main():
            ...
            assert isinstance(loop, veloxloop.VeloxLoop), f"Expected VeloxLoop, got {type(loop)}"
            ...
            assert type(transport).__name__ == 'UdpTransport', f"Expected UdpTransport, got {type(transport)}"
